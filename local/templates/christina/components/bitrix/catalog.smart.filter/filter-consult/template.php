...
?>
		...
		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="form_wr_ov-h">
			<div class="news__top">
				<h1 class="news__title consult_wr__title title">Консультация врача</h1>
				
				<div class="news__search_wr">
					<input type="text" placeholder="Найти" class="news__search" name="search[]" value="<?=$_GET['search'][0]?>">
				</div>
			</div>
			<div class="shop__filters consult_wr__filters shop_form">  
			...
			<?
				...
				foreach($arResult["ITEMS"] as $key=>$arItem)
				{
					...
					if (
						...
						continue;
					?>
					<div class="shop_form__grp">
					<p class="shop_form__grp_title"><?=$arItem["NAME"]?></p>
					<div class="shop_form__grp_inputs">	
									...
									?>
										<?foreach($arItem["VALUES"] as $val => $ar):?>
											<input type="checkbox" value="<? echo $ar["HTML_VALUE"] ?>"
															...
															<? echo $ar["CHECKED"]? 'checked="checked"': '' ?>
															onclick="smartFilter.click(this)">
											<label for="<? echo $ar["CONTROL_ID"] ?>" class="shop_form__item">
												<?=$ar["VALUE"];?> 
											</label>
				...
				?>
            <div class="shop_form__grp">
					<p class="shop_form__grp_title">Показать сначала</p>
					<div class="shop_form__grp_inputs">
						<input type="checkbox" name="sort[]" id="first_1" value="useful" <?if($_GET['sort'][0] == 'useful'):?>checked<?endif?>>
						<label for="first_1" class="shop_form__item">
							полезные
						</label>
						<input type="checkbox" name="sort[]" id="first_2" value="new" <?if($_GET['sort'][0] == 'new'):?>checked<?endif?>>
						<label for="first_2" class="shop_form__item">
							новые
						</label>
					</div>
				</div>
				<button type="submit"
								...
								class="btn shop_form__btn consult_wr__btn" >Показать</button>
				<div class="shop__toggle">Фильтр</div>
