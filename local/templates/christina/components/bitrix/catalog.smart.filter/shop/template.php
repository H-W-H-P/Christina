...
$('#subfilter').click(function(){
        ...
        //$('#resfilter').load('/include/filter.php',$('#formfilter').serializeArray());
    return false;
});
});
</script>

		<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="shop__filters shop_form" id="formfilter"> 
			...
			<?
				...
				?>
				<input type="hidden" name="set_filter"	value="<?=GetMessage("CT_BCSF_SET_FILTER")?>" />
				<button class="btn shop_form__btn" id="subfilter">Показать</button>
