...
?>
<div class="consult_wr__comments">
	<h4 class="consult_wr__title_small">Всего обсуждений <?=count($arResult["ITEMS"])?></h4>
					
	<?foreach($arResult["ITEMS"] as $arItem):?>
	<div class="consult_wr__comment comment close">
					<p class="comment__name"><?=$arItem['NAME']?></p>
